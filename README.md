...
- Creator upload flow for draft assets, bounded metadata/tags/payload size, payload shape validation, file/pasted JSON type auto-detect, and submit-for-review.
